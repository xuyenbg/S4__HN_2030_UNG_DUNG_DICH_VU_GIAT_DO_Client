...
class OrderRepo @Inject constructor(
    ...
    fun getDataOrder(idUser: String): Observable<MutableList<OrderResponse>> =
    ...
    fun insertOrder(order: Order): Observable<Unit> =
        api.insertOrder(order).subscribeOn(Schedulers.io())
